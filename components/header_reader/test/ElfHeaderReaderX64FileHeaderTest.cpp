...
TEST(ElfHeaderReaderX64TestSuite, shouldRead64BitLittleEndianFileHeaderOnHostLittleEndian)
{
...
TEST(ElfHeaderReaderX64TestSuite, shouldRead64BitBigEndianFileHeaderOnHostLittleEndian)
{
